...
import {
    ...
    SafeAreaView, ScrollView, TouchableOpacity, Alert, FlatList
}
    from 'react-native';
...
export default FlatListScreen = () => {
        ...
        return (
            <TouchableOpacity
                ...
                style={{
                    width: '90%',
                    height: 60,
                    backgroundColor: item.complate ? '#D0FF8A' : '#FFD64F',
                    borderRadius: 20,
                    margin: 10,
                    padding: 15,
                ...
                <Icon
                    name={item.complate ? 'check-circle' : 'check-circle-o'}
                    size={32}
                    color={item.complate ? '#0f0' : '#f00'}></Icon>
            </TouchableOpacity>
        )
    }
    ...
    const ItemSeparatorComponent = () => {
        return (
            <View style = {{margin: 5, height:1, width: '100%', backgroundColor: '#CCC'}}/>
        )
    }
